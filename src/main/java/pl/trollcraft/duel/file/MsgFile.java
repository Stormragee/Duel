package pl.trollcraft.duel.file;
...
public class MsgFile {
    ...
    public String getLeftInDuelMsg(String name) {
        return config.getString("player.left-in-duel").replaceAll("&", "§").replaceAll("%player%", name);
    }
